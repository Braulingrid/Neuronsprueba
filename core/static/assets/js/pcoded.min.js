...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://neuronsinclatam.com/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> More Starters' +
    '</a> ' + '</div>' + '');
var $window = $(window);
